...
description: Execute one BILDR task packet in its leased worktree and return the required structured handoff.
---

# Repository task

1. Read `CONTRIBUTING.md`, the task packet's named active authorities, and its
...
6. Return one `harness.orchestration.handoff.v1` object. State proof limits and the
...
7. Do not create/manage branches, rebase, push, open a pull request, merge, or add
   automation attribution. BILDR owns Git publication.
